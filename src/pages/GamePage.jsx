    ...
    <div className={style.game_container}>
      <div className={style.info_game_container}>
        ...
        <div>
          ...
          <button className={style.fav_btn + ' secondary'}>
      ...
      <div className={style.chat_game_container}>
        ...
        <div className={style.message_form_wrapper}> 
          <p style={{
            margin: '10px 0',
            padding: '0'
          }}>Chat message with gamers</p>
          <form className={style.message_form}>
            <input className={style.message_input} type="text" placeholder="type your message..." />
            <button type="submit" className={style.message_send_btn + ' contrast'}>
              Send
              <RiMailSendLine style={{
                marginLeft: '5px'
              }} />  
            </button>
          </form>
